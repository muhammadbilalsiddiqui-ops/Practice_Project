...
data class MarketData(
    ...
    val market_cap_fdv_ratio: Int,
    val market_cap_rank: Int,
    val market_cap_rank_with_rehypothecated: Int,
    val max_supply: Int,
    val max_supply_infinite: Boolean,
    val mcap_to_tvl_ratio: Any,
    val outstanding_supply: Int,
    val outstanding_token_value_usd: Any,
    ...
    val price_change_percentage_24h_in_currency: PriceChangePercentage1hInCurrency,
